	...
	class CED_FRUUGO_Manager {
 	 ...
 	 ini_set('display_errors', 0);
		...
		public function add_fruugo_required_fields( $fields = array(), $post = '' ) {
			// echo '<pre>'; print_r(); die('<br>'.__FILE__);
		...
		public function ced_fruugo_required_fields_process_meta_simple( $post_id ) {
			...
			// 	return;
			// }
			update_post_meta( $post_id, '_umb_fruugo_category', $_POST['_umb_fruugo_category'] );
			update_post_meta( $post_id, '_umb_fruugo_simple_title', $_POST['_umb_fruugo_simple_title'] );
			update_post_meta( $post_id, '_umb_fruugo_simple_desc', $_POST['_umb_fruugo_simple_desc'] );
			update_post_meta( $post_id, '_umb_fruggo_id_type', $_POST['_umb_fruggo_id_type'] );
			update_post_meta( $post_id, '_umb_fruugo_standard_code_val', $_POST['_umb_fruugo_standard_code_val'] );
			update_post_meta( $post_id, '_umb_fruugo_brand', $_POST['_umb_fruugo_brand'] );
			update_post_meta( $post_id, '_umb_fruugo_vat', $_POST['_umb_fruugo_vat'] );
			update_post_meta( $post_id, '_umb_fruugo_discount_price', $_POST['_umb_fruugo_discount_price'] );
			update_post_meta( $post_id, '_ced_increase_price_fruugo', $_POST['_ced_increase_price_fruugo'] );
			update_post_meta( $post_id, '_ced_fruugo_language_section', $_POST['_ced_fruugo_language_section'] );
			update_post_meta( $post_id, '_ced_fruugo_attributeSize', $_POST['_ced_fruugo_attributeSize'] );
			update_post_meta( $post_id, '_ced_fruugo_attributeColor', $_POST['_ced_fruugo_attributeColor'] );
			update_post_meta( $post_id, '_ced_fruugo_currency', $_POST['_ced_fruugo_currency'] );
			update_post_meta( $post_id, '_ced_fruugo_leadTime', $_POST['_ced_fruugo_leadTime'] );
			update_post_meta( $post_id, '_ced_fruugo_packageWeight', $_POST['_ced_fruugo_packageWeight'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute1', $_POST['_ced_fruugo_attribute1'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute2', $_POST['_ced_fruugo_attribute2'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute3', $_POST['_ced_fruugo_attribute3'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute4', $_POST['_ced_fruugo_attribute4'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute5', $_POST['_ced_fruugo_attribute5'] );
			update_post_meta( $post_id, '_ced_fruugo_attribute6', $_POST['_ced_fruugo_attribute6'] );
			...
			// 	foreach ( $sanitized_array as $key => $field_name ) {
