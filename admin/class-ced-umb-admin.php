...
class CED_FRUUGO_Admin {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_action( 'wp_ajax_ced_fruugo_assign_bulk_prof', array( $this, 'ced_fruugo_assign_bulk_prof' ) );
		...
		add_action('wp_ajax_ced_fruugo_save_cat_product_level',array($this,'ced_fruugo_save_cat_product_level'));
	...
	*/
	...
	/*
	* Bulk assign profile to product
	*/
	public function ced_fruugo_assign_bulk_prof() {
		$check_ajax = check_ajax_referer( 'frugo_nonce', 'nonce' );
		if ( !$check_ajax ) {
			return;
		}
		...
		foreach ( $variations as $variation_id ) {
			update_post_meta( $variation_id, 'ced_fruugo_profile', $profId );
		}
		...
		update_option( 'ced_fruugo_profile_assigned', $profId );
